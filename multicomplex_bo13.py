# manages well different stoich inputs. Stops after -f number of files are created. Not biased by a single input impose_clash.
...
if __name__ == "__main__":
    ...
    print(len(similar_chains_values_iter))
    print(len(structures))
    ...
    # 7. Call the recursive function and built the models with the desired stoichiometry.
